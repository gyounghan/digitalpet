...
SPECIES_ART = {
    ...
    "tiger1": {
        ...
        "eyes": [(3, 6, 4, 4), (10, 6, 4, 4)],  # 검수: 양눈 오른쪽 위로 2칸씩 확장
        "mouth": (7, 12),
    },
    ...
    "tiger2": {
        ...
        "eyes": [(3, 7, 4, 4), (10, 7, 4, 4)],  # 검수: 양눈 오른쪽 위로 2칸씩 확장
        "mouth": (6, 12),
    },
    ...
    "tiger3": {
        ...
        "eyes": [(4, 19, 3, 4), (14, 19, 3, 4)],  # 검수: 양눈 위로 1칸씩 확장
        "mouth": (9, 25),
    },
