...
class PetModelAdapter extends TypeAdapter<PetModel> {
  ...
  PetModel read(BinaryReader reader) {
    ...
    return PetModel(
      ...
      todayWaterCount: fields[59] as int? ?? 0,
      lastWaterDrinkHour: fields[63] as int? ?? -1,
      coins: fields[64] as int? ?? 0,
      equippedBackground: fields[65] as String? ?? '',
      todayFocusCount: fields[60] as int? ?? 0,
      waterAchievedCount: fields[61] as int? ?? 0,
      focusAchievedCount: fields[62] as int? ?? 0,
    );
  }
  ...
  void write(BinaryWriter writer, PetModel obj) {
    ...
    writer
      ..writeByte(66) // 필드 개수 (HiveField 0-65)
      ..writeByte(0)
      ..write(obj.id)
      ..writeByte(1)
      ...
      ..writeByte(59)
      ..write(obj.todayWaterCount)
      ..writeByte(60)
      ..write(obj.todayFocusCount)
      ..writeByte(61)
      ..write(obj.waterAchievedCount)
      ..writeByte(62)
      ..write(obj.focusAchievedCount)
      ..writeByte(63)
      ..write(obj.lastWaterDrinkHour)
      ..writeByte(64)
      ..write(obj.coins)
      ..writeByte(65)
