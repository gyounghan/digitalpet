...
void main() {
  group('BattleStyle 보정 배수', () {
    test('공격형: ATK 1.2 / DEF 0.9', () {
      expect(BattleStyle.attacker.attackMultiplier, 1.2);
      expect(BattleStyle.attacker.defenseMultiplier, 0.9);
    });
